                        ...
                        <div className="container">
                            <div className="row p-5">
                                <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                                    <img className="img-fluid" alt="img" src="file:///E:/templatemo_559_zay_shop/assets/img/banner_img_01.jpg" />
                                </div>
            ...
            <section className="container py-5">
                ...
                <div className="row">
                    <div className="col-12 col-md-4 p-5 mt-3">
                        <a href="google.com">
                            <img alt="img" className="rounded-circle img-fluid border" />
                        </a>
                    ...
                    <div className="col-12 col-md-4 p-5 mt-3">
                        <a href="google.com"><img alt="img" className="rounded-circle img-fluid border" /></a>
